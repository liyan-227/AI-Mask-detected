# Deployment Model CNN (Pendeteksi Pengunaan Masker)

## Deskripsi singkat

Repository ini berisi semua file yang dibutuhkan untuk melakukan deployment model Machine Learning Image Classification menggunakan CNN (Convolutional Neural Network). Adapun model yang digunakan merupakan model untuk memprediksi gambar Pendeteksi Pengunaan Masker (Face mask detected).

#

## Sekilas mengenai input model

Agar dapat memprediksi Pengunaan Masker, data input model harus mengikuti format sebagai berikut:
...
1. Buka URL dengan browser, coba masukkan gambar Pengunaan Masker yang ingin di prediksi.
